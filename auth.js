  ...
  if (loginForm) {
    loginForm.addEventListener("submit", async function (e) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          localStorage.setItem(
            ...
            JSON.stringify({
              ...
              nombreUsuario: data.user.name, // API devuelve "name"
              correo: data.user.email, // API devuelve "email"
            })
          );
        ...
        alert(
          "Error al conectar con el servidor.  Verifica que la API esté corriendo en https://localhost:7293"
        );
      }
    });
  }
