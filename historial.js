...
(function () {
  ...
  async function displayOrderHistory() {
    ...
    try {
      ...
      const url = getApiUrl(API_CONFIG. ENDPOINTS.CARRITO. GET_BY_USER(usuarioId));
  ...
  async function toggleOrderDetails(order) {
    ...
    try {
      ...
      const productUrl = getApiUrl(API_CONFIG. ENDPOINTS.PRODUCTOS.GET_BY_ID(productoId));
                ...
                <div class="order-items">
                    <div class="order-item">
                        ...
                        <div class="order-item-details">
                            ...
                            <p class="order-item-price">Precio unitario: $${precioUnitario.toFixed(2)}</p>
                        </div>
